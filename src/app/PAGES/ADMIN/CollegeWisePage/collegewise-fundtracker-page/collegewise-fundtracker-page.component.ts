...
@Component({
  selector: 'app-collegewise-fundtracker-page',
  templateUrl: './collegewise-fundtracker-page.component.html',
  styleUrls: ['./collegewise-fundtracker-page.component.css']
})
export class CollegewiseFundtrackerPageComponent implements OnInit 
{
